...
const contractABI = require("../artifacts/contracts/Audacityquill.sol/Audacityquill.json").abi;

program
    .name("audacityquill-cli")
    .description("CLI tool for Audacityquill smart contract")
    .version("1.0.0");
